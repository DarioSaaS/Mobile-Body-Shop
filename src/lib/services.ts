...
export const services: Service[] = [
  {
    ...
    points: ["Factory color-code matching", "Dust-controlled mobile booth"],
  },
  {
    slug: "bumper-repair",
    icon: "🚗",
    ...
    points: ["Plastic welding available", "Factory color-code matching"],
  },
  {
    ...
    points: ["Machine polish & buff", "Multi-layer clear coat"],
  },
];
